...
class NewsRepository {
  ...
  Future<CategoriesNewsModel> fetchNewsCategoriesApi(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=dcbabc799c1142399ef5feb941ffdb17';
  ...
  Future<NewsChannelsHeadlinesModel> fetchNewsChannelHeadlinesApi(String newsChannel) async {
    String newsUrl = 'https://newsapi.org/v2/top-headlines?sources=${newsChannel}&apiKey=dcbabc799c1142399ef5feb941ffdb17';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
